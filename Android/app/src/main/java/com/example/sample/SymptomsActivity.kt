...
class SymptomsActivity : AppCompatActivity(), DatePickerDialog.OnDateSetListener, TimePickerDialog.OnTimeSetListener {
    ...
    private var bloodSugar: Float= 0.0f
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        heartRate = intent.getStringExtra("HeartRate")!!.toFloat()
        respRate = intent.getStringExtra("RespiratoryRate")!!.toFloat()
        bloodSugar = intent.getStringExtra("BloodSugarLevel")!!.toFloat()
    ...
    private fun uploadRecords() {
        ...
        val record = RecordModel(recordId,
            heartRate,
            respRate,
            bloodSugar,
            spinMap[0]!!,
            ...
            spinMap[8]!!,
            spinMap[9]!!)
        dbRef.child(recordId).setValue(record).addOnCompleteListener{
            Toast.makeText(this, "Data Added", Toast.LENGTH_SHORT).show()
        }.addOnFailureListener{err ->
            Toast.makeText(this, "Error ${err.message}", Toast.LENGTH_SHORT).show()
        }

        val URL = "https://api.thingspeak.com/update?api_key=VU3IXS40QEL7RENH&field1=$heartRate&field2=$respRate&field3=25&field4=12&field5=1"
